...
# KUNCI REGION: 'eu' sudah sangat lengkap untuk liga malam (Eropa & Amerika)
ODDS_API_REGIONS = ["eu"]
...
def is_match_now_to_6am(commence_time):
    """
    PERBAIKAN 12 JAM: Hanya meloloskan pertandingan yang dimulai dari detik ini
    sampai maksimal 12 jam ke depan (Sangat akurat mengunci match malam & subuh).
    """
    ...
    # Toleransi mundur 2 jam (agar match yang baru kick-off tidak hilang)
    start_scan_utc = now_utc - timedelta(hours=2)
    
    # DIUBAH KE 12 JAM: Batasi scan maksimal tepat 12 jam ke depan dari sekarang
...
def build_raw_market_message(matches, total_leagues):
    msg = "📊 <b>TONIGHT PARLAY MATCH LIST (12-HOUR SCAN)</b>\n"
...
--- TEMPLATE OUTPUT ---
📋 **RINGKASAN PREDIKSI MATCH NIGHT (12H)**
...
def main():
    ...
    # Menjaga kapasitas penampung pasaran tetap luas
    matches = matches[:35]
    ...
    ai_msg = "🤖 <b>GPT-5.2 TONIGHT PARLAY ANALYSIS (12H)</b>\n\n"
