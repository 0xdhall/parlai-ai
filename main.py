...
def is_match_now_to_6am(commence_time):
    """Membuka filter menjadi rentang waktu fleksibel 24 jam ke depan"""
...
def parse_event(event, source="odds-api"):
    ...
    # Disederhanakan berdasarkan tanggal saja agar proses merging tidak pecah
...
def build_ai_prompt(matches):
    """
    PROMPT FINAL DIOPTIMALKAN: Memaksa model GPT memberikan keluaran yang ringkas, 
    to-the-point, dan sangat mudah dibaca tanpa narasi panjang lebar.
    """
    text = ""
...
def main():
    ...
    # Batasi maksimal 15 match agar aman dari token overflow & rapi di Telegram
    matches = matches[:15]
